...
def s_matching(e_kompost, file_path_eos):
    # Kompost entropy
...
def main():
    ...
    if len(sys.argv) != 5:
        print("Usage: python script.py type_of_matching <eos_file> <filename_in> <filename_out>")
        sys.exit(1)
    ...
    # s matching
        ...
        e_new, bulk_pressure = s_matching(energy_density, file_path_eos)  # GeV/fm^3
